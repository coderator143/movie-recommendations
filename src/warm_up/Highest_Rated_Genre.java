...
public class Highest_Rated_Genre {
    public static void main(String[] args) throws Exception {
        ...
        for(int x=1;x<=19;x++) {
            ...
            //System.out.println(sum_ratings + " " + count);
        ...
        String highest_rated_genre = genre.get(genre_id);

        System.out.println("Highest rated genre is "+ highest_rated_genre +" and the average rating is "
                + best_rating);
    }
}
